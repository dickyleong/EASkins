...
namespace EAStyles.WFControls
{
    #region ERoundRect

    static class ERoundRectangle
    {
    ...
    public class Emi_ThemeContainer : ContainerControl
    {
        ...
        protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
        {
            ...
            G.FillPath(new SolidBrush(Color.FromArgb(52, 52, 52)), ERoundRectangle.RoundRect(ClientRectangle, BorderCurve));
            // Draw a rectangle in which the controls should be added on
            G.FillPath(new SolidBrush(Color.FromArgb(246, 246, 246)), ERoundRectangle.RoundRect(new Rectangle(2, 20, Width - 5, Height - 42), BorderCurve));

            // Patch the header with a rectangle that has a curve so its border will remain within container bounds
            G.FillPath(new SolidBrush(Color.FromArgb(52, 52, 52)), ERoundRectangle.RoundRect(new Rectangle(2, 2, Width / 2 + 2, 16), BorderCurve));
            G.FillPath(new SolidBrush(Color.FromArgb(52, 52, 52)), ERoundRectangle.RoundRect(new Rectangle(Width / 2 - 3, 2, Width / 2, 16), BorderCurve));
            ...
            G.DrawPath(new Pen(Color.FromArgb(52, 52, 52)), ERoundRectangle.RoundRect(new Rectangle(2, 2, Width - 5, Height - 5), BorderCurve));
            G.DrawPath(new Pen(Color.FromArgb(52, 52, 52)), ERoundRectangle.RoundRect(ClientRectangle, BorderCurve));
    ...
    public class Emi_ControlBox : Control
    {
            ...
            switch (State)
            {
                ...
                case MouseState.Over:
                    ...
                    else if (i > 30 & i < 75)
                    {
                        ...
                        G.FillPath(xMinimizeGradient, ERoundRectangle.RoundRect(MinimizeRect, 1));
                        G.DrawPath(new Pen(Color.FromArgb(40, 40, 40)), GP_MinimizeRect);
                        G.DrawString("0", new Font("Marlett", 11, FontStyle.Regular), new SolidBrush(Color.FromArgb(221, 221, 221)), MinimizeRect.Width - 22, MinimizeRect.Height - 16);
                    }
                    else
    ...
    public class Emi_Button_1 : Control
    {
    ...
    public class Emi_Button_2 : Control
    {
    ...
    public class Emi_LinkLabel : LinkLabel
    {

        public Emi_LinkLabel()
        {
            Font = new Font("Segoe UI", 8, FontStyle.Regular);
            BackColor = Color.Transparent;
    ...
    public class Emi_HeaderLabel : Label
    {

        public Emi_HeaderLabel()
        {
    ...
    public class Emi_Toggle : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            checked
            {
                ...
                G.SmoothingMode = SmoothingMode.AntiAlias;
                G.FillPath(Gradient, (GraphicsPath)this.Pill(0, (int)Math.Round(unchecked((double)this.Height / 2.0 - (double)this.cHandle.Height / 2.0)), this.Width - 1, this.cHandle.Height - 5, new Emi_Toggle.PillStyle
                {
                    Left = true,
                    Right = true
                }));
                G.DrawPath(new Pen(Color.FromArgb(177, 177, 176)), (GraphicsPath)this.Pill(0, (int)Math.Round(unchecked((double)this.Height / 2.0 - (double)this.cHandle.Height / 2.0)), this.Width - 1, this.cHandle.Height - 5, new Emi_Toggle.PillStyle
                {
                    Left = true,
                    Right = true
                }));
    ...
    public class Emi_TextBox_Big : Control
    {
        #region Variables

        public TextBox EmiTB = new TextBox();
        private GraphicsPath Shape;
        ...
        public bool UseSystemPasswordChar
        {
            ...
            set
            {
                EmiTB.UseSystemPasswordChar = UseSystemPasswordChar;
        ...
        public bool Multiline
        {
            ...
            set
            {
                ...
                if (EmiTB != null)
                {
                    EmiTB.Multiline = value;

                    if (value)
                    {
                        EmiTB.Height = Height - 23;
                    }
                    else
                    {
                        Height = EmiTB.Height + 23;
                    }
                }
            }
        }
        ...
        public void AddTextBox()
        {
            ...
            _TB.Multiline = false;
            EmiTB.KeyDown += _OnKeyDown;
        }

        public Emi_TextBox_Big()
    {
    ...
    [DefaultEvent("TextChanged")]
    public class Emi_TextBox_Small : Control
    {
        #region Variables
        ...
        public bool Multiline
        {
            ...
            set
            {
                ...
                if (EmiTB != null)
                {
                    ...
                    if (value)
                    {
                        EmiTB.Height = Height - 10;
                    }
                    else
                    {
                        Height = EmiTB.Height + 10;
                    }
                }
            }
        }
    ...
    [DefaultEvent("TextChanged")]
    public class Emi_RichTextBox : Control
    {

        #region Variables

        public RichTextBox EmiRTB = new RichTextBox();
        private bool _ReadOnly;
        ...
        public bool AutoWordSelection
        {
            ...
            set
            {
                ...
                if (EmiRTB != null)
                {
                    EmiRTB.AutoWordSelection = value;
                }
            }
        }
        #endregion
        ...
        protected override void OnSizeChanged(System.EventArgs e)
        {
            ...
            EmiRTB.Size = new Size(Width - 13, Height - 11);
        }
    ...
    public class Emi_NumericUpDown : Control
    {
    ...
    public class Emi_ChatBubble_L : Control
    {
    ...
    public class Emi_ChatBubble_R : Control
    {
    ...
    public class Emi_Separator : Control
    {

        public Emi_Separator()
        {
    ...
    public class Emi_Panel : ContainerControl
    {
    ...
    public class Emi_GroupBox : ContainerControl
    {
        ...
        protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
        {
            ...
            G.FillPath(Brushes.White, ERoundRectangle.RoundRect(new Rectangle(1, 12, Width - 3, box.Height - 1), 8));
            // Draw the border of the GroupBox
            G.DrawPath(new Pen(Color.FromArgb(159, 159, 161)), ERoundRectangle.RoundRect(new Rectangle(1, 12, Width - 3, Height - 13), 8));

            // Draw the background of the title box
            G.FillPath(Brushes.White, ERoundRectangle.RoundRect(TitleBox, 1));
            // Draw the border of the title box
            G.DrawPath(new Pen(Color.FromArgb(182, 180, 186)), ERoundRectangle.RoundRect(TitleBox, 4));
    ...
    public class Emi_CheckBox : Control
    {
    ...
    [DefaultEvent("CheckedChanged")]
    public class Emi_RadioButton : Control
    {
        ...
        private void InvalidateControls()
        {
            ...
            {
                if (!object.ReferenceEquals(_Control, this) && _Control is Emi_RadioButton)
                {
                    ((Emi_RadioButton)_Control).Checked = false;
                }
            }
        }
    ...
    public class Emi_NotificationNumber : Control
    {
        #region Variables
    ...
    public class Emi_Listview : ListView
    {
        ...
        protected override void OnHandleCreated(EventArgs e)
        {
            Emi_Listview.SetWindowTheme(this.Handle, "explorer", null);
            base.OnHandleCreated(e);
        }
    }
    ...
    public class Emi_ComboBox : ComboBox
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            GP = ERoundRectangle.RoundRect(0, 0, Width - 1, Height - 1, 5);
    ...
    public class Emi_ProgressBar : Control
    {
    ...
    public class Emi_ProgressIndicator : Control
    {
    ...
    public class Emi_TabControl : TabControl
    {
    ...
    public class Emi_TrackBar : Control
    {
           ...
           protected override void OnMouseDown(MouseEventArgs e)
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            checked
            {
                this.PipeBorder = ERoundRectangle.RoundRect(1, 6, this.Width - 3, 8, 3);
                try
                {
                ...
                this.TrackBarHandle = ERoundRectangle.RoundRect(this.TrackBarHandleRect, 3);
    ...
    public class Emi_MenuStrip : MenuStrip
    {

        public Emi_MenuStrip()
        {
    ...
    public class Emi_ContextMenuStrip : ContextMenuStrip
    {

        public Emi_ContextMenuStrip()
        {
            this.Renderer = new ControlRenderer();
        }
    ...
    public class Emi_StatusStrip : StatusStrip
    {

        public Emi_StatusStrip()
        {
            this.Renderer = new ControlRenderer();
            SizingGrip = false;
        }
    ...
    public class Emi_Icon_Info : Control
    {
        public Emi_Icon_Info()
        {
    ...
    public class Emi_Icon_Tick : Control
    {

        public Emi_Icon_Tick()
        {
            this.ForeColor = Color.DimGray;
            this.BackColor = Color.FromArgb(246, 246, 246);
            this.Size = new Size(33, 33);
