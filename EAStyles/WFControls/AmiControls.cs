...
{
    #region ARoundRectangle

    static class ARoundRectangle
    {
    ...
    public class Ami_ThemeContainer : ContainerControl
    {
    ...
    public class Ami_ControlBox : Control
    {
    ...
    public class Ami_Button_1 : Control
    {
    ...
    public class Ami_Button_2 : Control
    {
    ...
    #region Link Label
    public class Ami_LinkLabel : LinkLabel
    {

        public Ami_LinkLabel()
        {
    ...
    public class Ami_HeaderLabel : Label
    {

        public Ami_HeaderLabel()
        {
    ...
    public class Ami_Separator : Control
    {

        public Ami_Separator()
        {
    ...
    public class Ami_ProgressBar : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            GP1 = ARoundRectangle.RoundRect(new Rectangle(0, 0, Width - 1, Height - 1), 4);
            GP2 = ARoundRectangle.RoundRect(new Rectangle(1, 1, Width - 3, Height - 3), 4);
            ...
            G.SetClip(GP1);
            G.FillPath(new SolidBrush(Color.FromArgb(244, 241, 243)), ARoundRectangle.RoundRect(new Rectangle(1, 1, Width - 3, Height / 2 - 2), 4));


            I1 = (int)Math.Round(((double)(this._Value - this._Minimum) / (double)(this._Maximum - this._Minimum)) * (double)(this.Width - 3));
            if (I1 > 1)
            {
                GP3 = ARoundRectangle.RoundRect(new Rectangle(1, 1, I1, Height - 3), 4);
    ...
    public class Ami_ProgressIndicator : Control
    {
    ...
    public class Ami_Toggle : Control
    {
        ...
        protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
        {
            ...
            GraphicsPath ControlPath = ARoundRectangle.RoundRect(ControlRectangle, 4);
            ...
            switch (ToggleType)
            {
                ...
                case _Type.OnOff_zh:
                    if (Toggled)
                    {
                        G.DrawString("开", new Font("Segoe UI", 12, FontStyle.Regular), Brushes.WhiteSmoke, Bar.X + 18, (float)(Bar.Y + 13.5), new StringFormat()
                        {
                            Alignment = StringAlignment.Center,
                            LineAlignment = StringAlignment.Center
                        });
                    ...
                    {
                        G.DrawString("关", new Font("Segoe UI", 12, FontStyle.Regular), Brushes.DimGray, Bar.X + 59, (float)(Bar.Y + 13.5), new StringFormat()
                        {
                            Alignment = StringAlignment.Center,
                            LineAlignment = StringAlignment.Center
                        });
            ...
            GraphicsPath SwitchPath = ARoundRectangle.RoundRect(SwitchRectangle, 4);
    ...
    public class Ami_CheckBox : Control
    {
    ...
    [DefaultEvent("CheckedChanged")]
    public class Ami_RadioButton : Control
    {
        ...
        private void InvalidateControls()
        {
            ...
            {
                if (!object.ReferenceEquals(_Control, this) && _Control is Ami_RadioButton)
                {
                    ((Ami_RadioButton)_Control).Checked = false;
                }
            }
        }
    ...
    public class Ami_ComboBox : ComboBox
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            GP = ARoundRectangle.RoundRect(0, 0, Width - 1, Height - 1, 5);
    ...
    public class Ami_NumericUpDown : Control
    {
    ...
    public class Ami_TrackBar : Control
    {
        ...
        protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
		    {
			    ...
			    PipeBorder = ARoundRectangle.RoundRect(1, 8, Width - 3, 5, 2);
			    ...
			    FillValue = ARoundRectangle.RoundRect(1, 8, TrackBarHandleRect.X + TrackBarHandleRect.Width - 4, 5, 2);
    ...
    public class Ami_Panel : ContainerControl
    {
        public Ami_Panel()
        {
            SetStyle(ControlStyles.SupportsTransparentBackColor, true);
    ...
    public class Ami_TextBox : Control
    {
        #region Variables

        public TextBox AmiTB = new TextBox();
        private GraphicsPath Shape;
        ...
        public bool UseSystemPasswordChar
        {
            ...
            set
            {
                AmiTB.UseSystemPasswordChar = UseSystemPasswordChar;
        ...
        public bool Multiline
        {
            ...
            set
            {
                ...
                if (AmiTB != null)
                {
                    AmiTB.Multiline = value;

                    if (value)
                    {
                        AmiTB.Height = Height - 10;
                    }
                    else
                    {
                        Height = AmiTB.Height + 10;
                    }
                }
            }
        }
        ...
        public void AddTextBox()
        {
            ...
            _TB.Multiline = false;
            AmiTB.KeyDown += _OnKeyDown;
            AmiTB.Enter += _Enter;
            AmiTB.Leave += _Leave;
            AmiTB.TextChanged += OnBaseTextChanged;
    ...
    [DefaultEvent("TextChanged")]
    public class Ami_RichTextBox : Control
    {

        #region Variables

        public RichTextBox AmiRTB = new RichTextBox();
        private bool _ReadOnly;
        ...
        public bool AutoWordSelection
        {
            ...
            set
            {
                ...
                if (AmiRTB != null)
                {
                    AmiRTB.AutoWordSelection = value;
                }
            }
        }
        #endregion
        ...
        {
            base.OnSizeChanged(e);
            AmiRTB.Size = new Size(Width - 13, Height - 11);
        }
    ...
    public class Ami_ListBox : ListBox
    {
    ...
    public class Ami_TabControl : TabControl
    {

        public Ami_TabControl()
        {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            G.FillPath(new SolidBrush(Color.FromArgb(247, 246, 246)), ARoundRectangle.RoundRect(0, 23, Width - 1, Height - 24, 2));
            G.DrawPath(new Pen(Color.FromArgb(201, 198, 195)), ARoundRectangle.RoundRect(0, 23, Width - 1, Height - 24, 2));
            ...
            for (int ItemIndex = 0; ItemIndex <= TabCount - 1; ItemIndex++)
            {
                ...
                if (ItemIndex == SelectedIndex)
                {
                    ...
                    // Draw header tabs
                    G.DrawPath(new Pen(Color.FromArgb(201, 198, 195)), ARoundRectangle.RoundedTopRect(new Rectangle(new Point(ItemBoundsRect.X - 2, ItemBoundsRect.Y - 2), new Size(ItemBoundsRect.Width + 3, ItemBoundsRect.Height)), 7));
                    G.FillPath(new SolidBrush(Color.FromArgb(247, 246, 246)), ARoundRectangle.RoundedTopRect(new Rectangle(new Point(ItemBoundsRect.X - 1, ItemBoundsRect.Y - 1), new Size(ItemBoundsRect.Width + 2, ItemBoundsRect.Height)), 7));
